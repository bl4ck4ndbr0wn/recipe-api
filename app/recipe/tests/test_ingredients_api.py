...
class PublicIngredientsApiTests(TestCase):
    """Test the publicy available ingridients api"""

    def setUp(self):
        self.client = APIClient()

    def test_login_required(self):
        """Test that login is required to access the endpiont"""
...
class PrivateIngedientsAPiTests(TestCase):
    ...
    def test_retrieve_ingredients_list(self):
        """test retrieve retrieving a list of ingredients"""
    ...
    def test_ingredients_limited_to_user(self):
        """Test that ingredietns for the authenticated user are returned"""
